...
# based on https://github.com/7h3rAm/pcapedit
# added per packet search capabilities: exact string matches within protocol fields or regexes within data
...
class editor(Cmd):
  intro = 'animated-winner - An Interactive Pcap Editor\n'
  prompt = '>>> '
  ...
  def help_commands(self):
    ...
    print 'Show a listing of available commands'
